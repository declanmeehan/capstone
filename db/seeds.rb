...
Synth.create({"name" => "acidic", "filename" => "blah.wav", "user_id" => 1 })
Synth.create({"name" => "keymaker", "filename" => "blahs.wav", "user_id" => 2 })
Synth.create({"name" => "paulverizer", "filename" => "bloo.wav", "user_id" => 1 })
